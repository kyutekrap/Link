...
gcc -c src\getdecor.c -o getdecor.o
...
gcc -o program main.o checkfile.o readenv.o getmacro.o delfile.o getdecor.o isempty.o getfiles.o getdeco.o getcomm.o lexer.o
